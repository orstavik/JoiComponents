...
describe('CSS values', function () {
  ...
  it("Tokenizer: red blue", function () {
    const tokens = new CssValueTokenizer("red blue");
    const tokensRes = tokensToArray(tokens);
    expect(tokensRes).to.deep.equal([
      ["red", undefined, "red", undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined],
      [" ", " ", undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined],
      ["blue", undefined, "blue", undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined],
    ]);
  });

  it("Parser: red blue", function () {
  ...
  /*
    // var test1 = "-124px +3.5px -100vh +2.1vw -3.4px -4.5 1.2 .3";
  ...
  //  var res = test1.trim();
    var res1 = parseCssValue(test1);
    var res2 = parseCssValue(test2);
    var res3 = parseCssValue(test3);
    var res4 = parseCssValue(test4);
    var res5 = parseCssValue(test5);
    var res6 = parseCssValue(test6);
    var res7 = parseCssValue(test7);
    var res8 = parseCssValue(test8);
    var res9 = parseCssValue(test9);
    console.log(res9);
    */
});