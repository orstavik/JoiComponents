function dispatchPreventableTrailingEvent(target, triggerEvent, eventGeneratorFn) {
  let composedEvent = eventGeneratorFn();
  ...
  setTimeout(function () {
    triggerEvent.defaultPrevented || target.dispatchEvent(composedEvent);
  }, 0);
}
...
mouseStartListener = e => mouseStart(e);
mouseMoveListener = e => mouseMove(e);
mouseStopListener = e => mouseStop(e);

cachedEvents = undefined;
cachedTouchAction = undefined; //block touchAction
cachedUserSelect = undefined; //block userSelection
active = 0; //0 = inactive, 1 = mouse, 2 = touch
...
//todo should I add this after touchstart or mousedown?
