...
In this pattern we can't do that as we want to **allow** changes to the batch register *below*
the current point of iteration to be included and **always iterate in TreeOrder**.
