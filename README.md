...
6. [Problem: SlotchangeNipSlip](book/chapter3_slot_matroska/6_Problem_SlotchangeEavesdropping)
7. [Theory: VariableExpectations](book/chapter3_slot_matroska/7_Theory_VariableExpectations)
